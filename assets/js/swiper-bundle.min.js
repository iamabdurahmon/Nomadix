...
!(function (e, t) {
    ...
    for (var e = Object(arguments.length <= 0 ? void 0 : arguments[0]), t = ["__proto__", "constructor", "prototype"], a = 1; a < arguments.length; a += 1) {
      ...
      if (null != i)
        for (
          ...
          void 0 !== o &&
            o.enumerable &&
            (C(e[l]) && C(i[l]) ? (i[l].__swiper__ ? (e[l] = i[l]) : S(e[l], i[l])) : !C(e[l]) && C(i[l]) ? ((e[l] = {}), i[l].__swiper__ ? (e[l] = i[l]) : S(e[l], i[l])) : (e[l] = i[l]));
        }
    }
    return e;
  }
          ...
          if (l && (!l || 0 !== Object.keys(l).length)) {
            ...
            if (o && e.currentBreakpoint !== o) {
              ...
              u && !c
                ...
                : !u &&
                  c &&
                  (n.addClass(r.containerModifierClass + "multirow"), "column" === p.slidesPerColumnFill && n.addClass(r.containerModifierClass + "multirow-column"), e.emitContainerClasses());
  ...
  var _ = {
      update: function (e) {
        ...
        if ((S(t.virtual, { from: w, to: E, offset: x, slidesGrid: t.slidesGrid }), p === w && u === E && !e))
    ...
    J = {
      ...
      render: function () {
        ...
        if (t.el && e.pagination.el && e.pagination.$el && 0 !== e.pagination.$el.length) {
          ...
          "fraction" === t.type &&
            ((s = t.renderFraction ? t.renderFraction.call(e, t.currentClass, t.totalClass) : '<span class="' + t.currentClass + '"></span> / <span class="' + t.totalClass + '"></span>'), i.html(s)),
    ...
    pe = {
      ...
      setTransition: function (e) {
        var t = this,
          ...
          s = t.$wrapperEl;
        if (
          (a.transition(e).find(".swiper-slide-shadow-top, .swiper-slide-shadow-right, .swiper-slide-shadow-bottom, .swiper-slide-shadow-left").transition(e), t.params.virtualTranslate && 0 !== e)
        ) {
          var r = !1;
